...
#include <stdlib.h>
#include <time.h>
#include "../src/sse2_256mc.h"

void sse2_256mc_add_n_test()
{
	int i;
	...
	a[0] = 0xFFFFFFFFFFFFFFFEUL;
	a[1] = 0xFFFFFFFFFFFFFFFEUL;

	b[0] = 0xFFFFFFFFFFFFFFFEUL;
	b[1] = 0xFFFFFFFFFFFFFFFEUL;
